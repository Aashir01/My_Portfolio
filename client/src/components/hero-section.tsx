        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className={`text-center lg:text-left transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              ...
              <div className="text-3xl sm:text-4xl lg:text-5xl mt-2">Applied AI Engineer | LLM & Agentic Systems Engineer</div>
            </h1>

            <p className="text-xl text-muted-foreground mb-8 max-w-2xl" data-testid="text-hero-description">
              An Applied AI Engineer specializing in building production-grade AI systems powered by Large Language Models (LLMs),
              autonomous agents, and machine learning. Delivering scalable AI solutions that support business decision-making and automation.
            </p>
